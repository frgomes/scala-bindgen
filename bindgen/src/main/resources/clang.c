...
#define DEFINE_ENUM(tpe, id) EXTERN_FUNCTION0(bindgen_clang_##id, id, tpe)

#define PRIMITIVE_GETTER(tpe, name, argType, arg) \
  EXTERN_FUNCTION1(bindgen_clang_##name, name, tpe, argType, arg)

#define COPY_GETTER(tpe, name, argType, arg) \
  EXTERN_FUNCTION1(bindgen_clang_##name, name, tpe, argType, arg)

#define STRING_GETTER(name, argType, arg) \
  EXTERN_FUNCTION1(bindgen_clang_##name, name, CString, argType, arg)
